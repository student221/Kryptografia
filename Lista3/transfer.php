...
if (isset($_POST['btn-send'])) {
	...
	if (!$error) {
		...
		$query = "INSERT INTO transfers(transferAmount, transferDate, transferOwner, transferTarget, transferTitle) VALUES('$amount', CURDATE(), '$myAccount', 'CCCCCCCCCC-CCCCCCCCCC-CCCCCCCCCC', '$title')";
			...
			<div class = "col-md-12">
				...
				<div class = "form-group">
					<div class = "input-group">
						...
						<input type = "text" name = "account" class = "form-control" placeholder = "Enter Account Number" maxlength = "32" value = "<?php echo $account ?>" />
					</div>
